...
\begin{paracol}{2}
    ...
    { 
        ...
        with international users takes place across different time zones.
        Moreover, I have been first author of 6 peer-reviewed journal articles
        in particle dynamics during my time at the academia, collaborating
        closely with leading scientific minds. All this was possible, thanks to
        my exceptional adaptability to rapidly changing environments and my
        extraordinary analytical and team skills. I am now seeking new
        opportunities as a Lead Software Engineer, where I can leverage my
        expertise in simulation and analytical problem-solving to contribute to
        cutting-edge innovations in the autonomy stack.\\
...
}
{
    ...
    \subsection{October 2015 - April 2016}{Fraunhofer Institute (ITWM), Kaiserslautern}
        {{\bfseries Internship} in the department of mathematics for vehicle engineering}\\
}
\end{paracol}
...
\begin{paracol}{2}
    ...
    }
    {
        \rsection{Educational Qualification}
            ...
            {University of Stuttgart, Grade: 1.0 ({\bfseries magna sum laude})}
              \begin{itemize}
...
=======
    Activity Metrics from Ring Down Experiments. Journal of Sound Vibration, 2019.
>>>>>>> Stashed changes
