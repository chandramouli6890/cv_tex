...
\begin{center}
    ...
    \vspace{0.2cm}
    {\Large \textbf{Software Developer C++}}
    
    \vspace{0.1cm}
    \colorbox{gray!40}{%
        \parbox{0.99\textwidth}{%
            \centering \textcolor{highlightcolor}{\textbf{Advancing Intelligent Systems with Expertise in C++ and Scalable Software Architectures}}
        }%
    }
\end{center}
...
programming with C++ and simulation tool development. Skilled in agile
principles, Linux-based development, and expanding scalable software
...
\begin{itemize}
    ...
    \item [$\textcolor{highlightcolor}{\checkmark}$] \textcolor{highlightcolor}{\textbf{Developed a service-oriented data processing pipeline}} for extreme event analysis using big-data analytics.
...
\begin{itemize}[itemsep=0pt, topsep=5pt]
  ...
  \item Collaborated with cross-functional teams to develop ISO-26262 compliant integration and validation strategies.
...
\begin{itemize}[itemsep=0pt, topsep=5pt]
    ...
    \item Development and administration of the multi-threaded particle
        simulation software Pasimodo in C++14, utilizing shared memory
        multiprocessing for efficient parallel computation.
